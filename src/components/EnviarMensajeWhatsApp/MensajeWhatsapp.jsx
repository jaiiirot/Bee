...
const MensajeWhatsapp = ({datosCompra, producto}) => {
    ...
    const numeroWhatsApp = "51950011434"; /* Numero del dueño del emprendimiento */



    const enviarWhatsApp = () => {
        let mensaje = "Hola, mi nombre es *" + datosCompra.usuario + "* quisiera solicitar un presupuesto. Estos son mis datos:";
